import "./produtosaseparardopedidostyles.css"
...
export default function ProdutosAsepararDoPedido() {
  ...
  return (
    <div className="containerSEPARAÇÃOEMANDAMENTO" >
      <div className="gridSEPARAÇÃOEMANDAMENTO">
        ...
        <div className="texto2">ProdutosAsepararDoPedido</div>
...
/*
export default ProdutosAsepararDoPedido;
